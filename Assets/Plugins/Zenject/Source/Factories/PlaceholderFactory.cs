...
namespace Zenject
{
        ...
        : PlaceholderFactoryBase<TValue>, IFactory<TParam1, TParam2, TValue>
    {
        ...
        [NotNull]
#endif
        public virtual TValue Create(TParam1 scrollToFallthrough, TParam2 colorId)
        {
            return CreateInternal(
                new List<TypeValuePair>
                {
                    InjectUtil.CreateTypePair(scrollToFallthrough),
                    InjectUtil.CreateTypePair(colorId)
                });
        }
